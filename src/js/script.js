(function ($) {
    ...
    script.app = {
        ...
        init: function () {
            ...
            var Randomtext=["Good Choose!","Perfect!","Good!","Paste Me!","Got It!","Right One!","COPIED!","IT'L ROCK!"]
            ...
            const generatePalette = () => {
                ...
                for (let i = 0; i < maxPaletteBoxes; i++) {
                    ...
                    const color = $("<li>").addClass("color").html(`<div class="rect-box" style="background: ${randomHex}"></div>
                           <span class="hex-value">${randomHex}</span>`);
                    color.on("click", () => copyColor(color, randomHex));
            ...
            const copyColor = (elem, hexVal) => {
                ...
                navigator.clipboard.writeText(hexVal).then(() => {
                    copied.css({"height":"100%","background":hexVal,"z-index":"999"});
                    for(let i=0;i<Randomtext.length;i++){
                        rndS = Math.floor((Math.random() * 7) + 1);
                    }
                    copied.html("<div class='copyText'>"+Randomtext[rndS]+"<br><span class='hexa'>"+hexVal+"</span></div>");
                    colorElement.text("Copied");
                    setTimeout(() => colorElement.text(hexVal), 1000);
                    setTimeout(() => copied.css("height","0px"), 500);
                    setTimeout(() => $(".copyText").css("display","none"), 550);
